...
class ElastPrecoAndroid extends StatefulWidget {
  ElastPrecoAndroid();

  set servidor(String servidor) {}

  @override
  _ElastPrecoAndroidState createState() => _ElastPrecoAndroidState();
}

class _ElastPrecoAndroidState extends State<ElastPrecoAndroid> {
                  ...
                  child: Row(children: [
                    Column(children: [
                      ...
                      SfCartesianChart(
                          ...
                          // Chart title
                          title: ChartTitle(text: 'Previsão de Vendas - 1 Ano'),
                          // Enable legend
                          legend: Legend(isVisible: true),
                          // Enable tooltip
