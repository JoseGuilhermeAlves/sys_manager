...
class ElastPreco extends StatefulWidget {
  ElastPreco();

  set servidor(String servidor) {}

  @override
  _ElastPrecoState createState() => _ElastPrecoState();
}

class _ElastPrecoState extends State<ElastPreco> {
