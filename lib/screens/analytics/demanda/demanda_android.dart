...
class DemandaAndroid extends StatefulWidget {
  DemandaAndroid();

  set servidor(String servidor) {}

  @override
  _DemandaAndroidState createState() => _DemandaAndroidState();
}

class _DemandaAndroidState extends State<DemandaAndroid> {
